...
# ==========     =========      ==============================
# Mohsin Ali     01/12/2022     Original coding using python 2.7.x on windows 8.1 and ubuntu 14.04 (pg 9.4)
# Mohsin Ali     01/13/2022     Finished porting code from bash script, pg_refreshstats.sh
# Mohsin Ali     01/14/2022     First crack at incorporated logic for report action.
# Mohsin Ali     01/17/2022     Implemented report output in html
# Mohsin Ali     01/18/2022     Fixed a bunch of bugs with html reporting
# Mohsin Ali     01/20/2022     Removed linux dependency on psutils module.
#                                   Enhanced unused indexes report to query slaves if available
# Mohsin Ali     01/21/2022     Fixed bugs, normalized html output, added connection and locking report
# Mohsin Ali     01/23/2022     Reworked html output to display health check at top of page and lists at the bottom.
# Mohsin Ali     01/25/2022     Added more health check items: writers, network standbys.  Implemented logic related to
#                                   checkpoint, background and backend writers and the pg_stat_bgwriter table.
# Mohsin Ali     01/27/2022     loop over tables being worked on, instead of executing
#                                   them in batch: analyze, vacuum analyze, and vacuum freeze actions.
# Mohsin Ali     01/28/2022     Fixed python piping to use bash as default shell
# Mohsin Ali     10/04/2017     Fix queries based on PG versions since 9.5 (ie 9.6 and 10)
# Mohsin Ali     10/16/2020     Qualify vacuumlo command with port number. It had assumed default, 5432
# Mohsin Ali     12/08/2020     Majore rewrite: converted pg_maint health check portion to replace old pg_report that also did vacuum actions
# Mohsin Ali     12/09/2020     Added new functionality and made changes to be more compatible across Python versions 2 and 3:
#                                   Changed "<>" to <!=>   
...
# Mohsin Ali     01/01/2021     v2.1 new features: Connection time avg, PG major/minor version evaluation
...
# Mohsin Ali     01/12/2021     v2.1 fix: Heroku instances should be treated like rds ones
# Mohsin Ali     09/06/2021     v2.2 fix for print commands using parens; don't consider walsender for waiting/blocked queries
# Mohsin Ali     05/29/2022     v2.3 Check local load
# Mohsin Ali     06/23/2022     v2.4 Bug fixes. Do not check local resources for remote DB servers.  Updated latest versions of PG.
################################################################################################################
...
class maint:
    ...
    def initreport(self):
        ...
        info = \
            ...
            "</div>\n" + contextline + \
            "<a href=\"https://github.com/MohsinDBA/pg_report\">pg_report</a>  is available on github.\n" + \
            "Send me mail at <a href=\"mailto:mohsin@visetech.ae\"> support@visetech.ae</a>.\n" + \
            "<HR>\n"
